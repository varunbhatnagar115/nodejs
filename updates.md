...
This buildpack contains updated Node.js versions which address recent security vulnerabilities found in Node.js.  Users should update their applications to use the latest versions available and then restage the applications in Bluemix.  See <a href="https://nodejs.org/en/blog/vulnerability/july-2017-security-releases/">this link</a> for details on the Node.js vulnerabilities.
